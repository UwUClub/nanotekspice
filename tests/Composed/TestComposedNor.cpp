...
Test(Nor, Nor1, .init = cr_redirect_stdout) {
    int ac = 2;
    char *av[2] = {(char *) "./nanotekspice", (char *) "tests/nts_single/nor.nts"};
...
Test(Nor, Nor2, .init = cr_redirect_stdout) {
    int ac = 2;
    char *av[2] = {(char *) "./nanotekspice", (char *) "tests/nts_single/nor.nts"};
    nts::Parser parser(ac, av);
    nts::Handler handler;
...
Test(Nor, Nor3, .init = cr_redirect_stdout) {
    int ac = 2;
    char *av[2] = {(char *) "./nanotekspice", (char *) "tests/nts_single/nor.nts"};
    nts::Parser parser(ac, av);
    nts::Handler handler;
...
Test(Nor, Nor4, .init = cr_redirect_stdout) {
    int ac = 2;
    char *av[2] = {(char *) "./nanotekspice", (char *) "tests/nts_single/nor.nts"};
    nts::Parser parser(ac, av);
    nts::Handler handler;
