...
Test(Xor, Xor, .init = cr_redirect_stdout)
{
    int ac = 2;
    char *av[2] = {(char *)"./nanotekspice", (char *)"tests/nts_single/xor.nts"};
...
Test(Xor, Xor2, .init = cr_redirect_stdout)
{
    int ac = 2;
    char *av[2] = {(char *)"./nanotekspice", (char *)"tests/nts_single/xor.nts"};
    nts::Parser parser(ac, av);
...
Test(Xor, Xor3, .init = cr_redirect_stdout)
{
    int ac = 2;
    char *av[2] = {(char *)"./nanotekspice", (char *)"tests/nts_single/xor.nts"};
    nts::Parser parser(ac, av);
...
Test(Xor, Xor4, .init = cr_redirect_stdout)
{
    int ac = 2;
    char *av[2] = {(char *)"./nanotekspice", (char *)"tests/nts_single/xor.nts"};
    nts::Parser parser(ac, av);
